...
public class Spacecraft extends PointBody {
    ...
    public Spacecraft(String name, Vector2 position, double mass, double radius) {
        super(position, mass);
        this.radius = radius;
        displayComponent = new PlanetDisplay(name, color, radius);
        update();
    ...
    public Spacecraft(String name, Vector2 position, Vector2 velocity, double mass, double radius) {
    ...
    public Spacecraft clone() {
        Spacecraft newTestObject = new Spacecraft("Clone", this.position(), this.velocity(), this.mass(), this.radius);
